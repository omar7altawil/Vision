...
app.setHandler({
    ...
    'DescribeIntent':async function() {
        ...
        var Descrption=await ref.once("value").then((snapshot) =>{
            return snapshot.val();});
        this.ask("Right now you are in the "+room+" inside the Mother of UAE building in Abu Dhabi Unversity, "+Descrption,"can i help you with something else?")
    },
